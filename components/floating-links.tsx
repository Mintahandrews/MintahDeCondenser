...
export const FloatingLinks = () => {
  ...
  const links = [
    {
      url: 'https://github.com/mintahandrews',
      icon: (
    ...
    {
      url: 'https://buymeacoffee.com/codemintah',
      icon: (
        <svg viewBox="0 0 24 24" className="w-5 h-5 fill-current">
      ...
      bgColor: 'bg-[#FFDD00] hover:bg-[#FFE838]',
    },
  ];
          ...
          >
            {links.map((link, index) => (
              <motion.a
                ...
                className={`${link.bgColor} text-white p-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center`}
                title={link.label}
              >
                {link.icon}
              </motion.a>
